...
$(NAME):	$(OBJ)
			$(MAKE) -C libft
			$(CC) $(CFLAGS) -Llibft -lft -lreadline -L/opt/homebrew/Cellar/readline/8.1.2/lib -ltermcap $(OBJ) -o $(NAME)

bonus:

%.o: %.c
			$(CC) $(CFLAGS) -Iinclude -Ilibft -I/opt/homebrew/Cellar/readline/8.1.2/include -c $< -o $@
